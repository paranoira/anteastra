...
export const ui = {
  hu: {
    ...
    location: {
      ...
      privacy: "A böngésző csak gombnyomásra kér helyhozzáférést. A helyzetet nem küldjük az AnteAstra szerverére.",
    ...
    privacy: {
      label: "Adatkezelés:",
      text: "a mentett helyszín csak ebben a böngészőben marad. Az időzóna, a becsült magasság és az időjárás meghatározásához a koordinátát az Open-Meteo szolgáltatás kapja meg."
    },
    about: {
  ...
  en: {
    ...
    location: {
      ...
      privacy: "Your browser asks for location access only when you press the button. Your position is not sent to an AnteAstra server.",
    ...
    privacy: {
      label: "Privacy:",
      text: "the saved location stays in this browser only. The coordinates are sent to Open-Meteo to determine the time zone, estimated elevation and weather."
    },
    about: {
